...
class Packfile {
     ...
     * @return int
     */
    static function bin_fuint32($handle) {
     ...
     * @return int
     */
    static function bin_uint32($str, $pos = 0) {
     ...
     * @return int
     */
    static function git_varint($str, &$pos = 0) {
        $r = 0;
        $c = 0x80;
        for ($i = 0; $c & 0x80; $i += 7)
        {
     ...
     */
    static function readFanOut($handle, $object_name, $offset) {
     ...
     */
    static function applyDelta($delta, $base) {
        $pos = 0;
